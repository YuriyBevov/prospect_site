...
if (accordeon) {
  ...
  var fields = accordeon.querySelectorAll('.accordeon__field');
  ...
  var onClickOpenaccordeonField = function onClickOpenaccordeonField(evt) {
    ...
    if (!target.classList.contains('active')) {
      ...
      var body = target.querySelector('.accordeon__body');
...
if (map) {
  ...
  function init() {
    ...
    var myPlacemark = new ymaps.Placemark(myMap.getCenter(), {}, {
      ...
      iconImageHref: 'assets/img/map-placeholder.svg',
      // Размеры метки.
      iconImageSize: [50, 50],
    ...
    "<div class='zoom-btns'>" + "<button id='zoom-in' class='zoom-btn zoom-btn-in'>" + "<svg width='14' height='14'>" + "<use xlink:href='./assets/sprite.svg#icon-zoom-in'>" + "</svg>" + "</button>" + "<button id='zoom-out' class='zoom-btn zoom-btn-out'>" + "<svg width='14' height='2'>" + "<use xlink:href='./assets/sprite.svg#icon-zoom-out'>" + "</svg>" + "</button>" + "</div>", {
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_video__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/video */ "./src/scripts/modules/video.js");
/* harmony import */ var _modules_video__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_video__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _modules_yandexMap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/yandexMap */ "./src/scripts/modules/yandexMap.js");
